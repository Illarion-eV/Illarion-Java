...
/**
 * A exception that is triggered in case the LWJGL port causes any problem.
 * 
 * @author Martin Karing
 * @version 2.00
 * @since 2.00
 */
final class InputLWJGLException extends InputException {
    /**
     ...
     */
    public InputLWJGLException(final String message) {
        super(message);
    }
     ...
     */
    public InputLWJGLException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause the cause for this exception
     */
    public InputLWJGLException(final Throwable cause) {
        super(cause);
    }
}
