...
/**
 * A exception that is triggered in case the JAVA port causes any problem.
 * 
 * @author Martin Karing
 * @version 2.00
 * @since 2.00
 */
final class InputJAVAException extends InputException {
    /**
     ...
     */
    public InputJAVAException(final String message) {
        super(message);
    }
     ...
     */
    public InputJAVAException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause the cause for this exception
     */
    public InputJAVAException(final Throwable cause) {
        super(cause);
    }
}
