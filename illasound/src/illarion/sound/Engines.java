...
/**
 * A list of the engines that this sound port offers to ensure a valid engine is
 * selected.
 * 
...
enum Engines {
    /**
     * Constant for the native java implementation.
     */
    @SuppressWarnings("nls")
    javax("javax", "JAVAX"),

    /**
     * Constant for the LWJGL 2D Graphic engine working with OpenAL.
     */
    @SuppressWarnings("nls")
    lwjgl("lwjgl", "LWJGL");
