package org.illarion.nifty.controls.illaButton;
...
/**
 * Implementation of the illaButton Control.
 * @author void, martin
 */

public class illaButtonControl extends AbstractController implements Button {
	  private Nifty nifty;
	  ...
	  public void init(final Properties parameter, final Attributes controlDefinitionAttributes) {
	    EventTopicSubscriber<NiftyMousePrimaryClickedEvent> mouseClickedSubscriber = new EventTopicSubscriber<NiftyMousePrimaryClickedEvent>() {
	      ...
	      public void onEvent(final String topic, final NiftyMousePrimaryClickedEvent data) {
	        nifty.publishEvent(topic, new ButtonClickedEvent(illaButtonControl.this));
	      }
	    };
