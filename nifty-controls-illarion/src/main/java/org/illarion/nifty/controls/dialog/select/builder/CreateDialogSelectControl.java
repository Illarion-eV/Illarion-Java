 ...
 */
public class CreateDialogSelectControl extends ControlAttributes {
    /**
     * The identifier string of the input dialog control.
     */
    static final String NAME = "dialog-select";

    /**
     * Create a new input dialog with a automatically generated ID.
     */
    public CreateDialogSelectControl() {
     ...
     */
    public CreateDialogSelectControl(@Nonnull final String id) {
        setId(id);
        setName(NAME);
    }
     ...
     */
    @Nullable
    public DialogSelect create(@Nonnull final Nifty nifty, @Nonnull final Screen screen, @Nonnull final Element parent) {
