...
/**
 * This is a magic type condition. Its able to parse a magic type value out of the NPC condition line.
 *
 * @author Martin Karing &lt;nitram@illarion.org&gt;
 */
public final class MagicType extends ConditionParser {
    /**
     * This pattern is used to find the state operation in the condition
     * properly.
     */
    @SuppressWarnings("nls")
    private static final Pattern MAGIC_TYPE_FIND = Pattern.compile("\\s*magicType\\s*=\\s*([a-z]+)\\s*,\\s*",
    ...
    public void enlistHighlightedWords(@Nonnull final TokenMap map) {
        map.put("magicType", Token.RESERVED_WORD);
    }
}
