...
/**
 * This is the introduce consequence. Its able to parse a introduce consequence out of the consequence collection
 * string.
 *
...
public final class Introduce extends ConsequenceParser {
    ...
    private static final Pattern STRING_FIND = Pattern.compile("\\s*introduce\\s*,\\s*", Pattern.CASE_INSENSITIVE);
    ...
    public TalkConsequence extract() {
        ...
        if (stringMatcher.find()) {
            return new ConsequenceIntroduce();
        }
