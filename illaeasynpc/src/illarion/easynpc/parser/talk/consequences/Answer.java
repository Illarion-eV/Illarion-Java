...
/**
 * This is the answer consequence. Its able to parse a answer out of the consequence collection string.
 *
...
public final class Answer extends ConsequenceParser {
    ...
    public TalkConsequence extract() {
        ...
        if (stringMatcher.find()) {
            final String answer = stringMatcher.group(1).replace("''", "\\\"");
            setLine(stringMatcher.replaceFirst("").replace("''", "\\\""));

            return new ConsequenceAnswer(answer);
        }
