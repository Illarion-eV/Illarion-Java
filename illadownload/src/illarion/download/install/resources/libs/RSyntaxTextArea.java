...
/**
 * This resource contains the RSyntaxTextArea editor for the Swing environment.
 *
 * @author Martin Karing
 */
public final class RSyntaxTextArea implements LibraryResource {
    /**
     * The singleton instance of this class.
     */
    private static final RSyntaxTextArea INSTANCE = new RSyntaxTextArea();
    ...
    public String getName() {
        return Lang.getMsg(RSyntaxTextArea.class.getName());
    }
        ...
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH
                        + "rsyntaxtextarea" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
    ...
    public Collection<String> getVMArguments() {
        if (vmArguments == null) {
            ...
            vmArgs.add("-Dillarion.components.avaiable.rsyntaxtextarea=true"); //$NON-NLS-1$
