...
/**
 * This resource contains the JAX-RPC
 *
 * @author Martin Karing
 */
public final class JaxRpc
        implements LibraryResource {
    /**
     * The singleton instance of this class.
     */
    private static final JaxRpc INSTANCE = new JaxRpc();
    ...
    public Collection<File> getClassPath() {
        if (classpath == null) {
            ...
            cp.add(new File(dir, "jaxrpc.jar")); //$NON-NLS-1$
    ...
    public String getName() {
        return Lang.getMsg(JaxRpc.class.getName());
    }
    ...
    public Collection<URL> getRequiredResources() {
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH + "jaxrpc" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
    ...
    public Collection<String> getVMArguments() {
        if (vmArguments == null) {
            ...
            vmArgs.add("-Dillarion.components.avaiable.jaxrpc=true"); //$NON-NLS-1$
