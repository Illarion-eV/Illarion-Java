...
/**
 * This resource contains the Substance Look&Feel for SwingX.
 *
 * @author Martin Karing
 * @version 1.00
 * @since 1.00
 */
public final class SubstanceSwingX
        implements LibraryResource {
    /**
     * The singleton instance of this class.
     */
    private static final SubstanceSwingX INSTANCE = new SubstanceSwingX();
    ...
    public String getName() {
        return Lang.getMsg(SubstanceSwingX.class.getName());
    }
    ...
    public Collection<URL> getRequiredResources() {
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH + "substance-swingx" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
    ...
    public Collection<String> getVMArguments() {
        if (vmArguments == null) {
            ...
            vmArgs.add("-Dillarion.components.avaiable.substance-swingx=true"); //$NON-NLS-1$
