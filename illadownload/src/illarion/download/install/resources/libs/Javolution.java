...
/**
 * This resource contains the Javolution RTS library.
 * 
 * @author Martin Karing
 * @since 1.00
 * @version 1.00
 */
public final class Javolution implements LibraryResource {
    /**
     * The singleton instance of this class.
     */
    private static final Javolution INSTANCE = new Javolution();
    ...
    public String getName() {
        return Lang.getMsg(Javolution.class.getName());
    }
        ...
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH
                    + "javolution" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
    ...
    public Collection<String> getVMArguments() {
        if (vmArguments == null) {
            ...
            vmArgs.add("-Dillarion.components.avaiable.javolution=true"); //$NON-NLS-1$
