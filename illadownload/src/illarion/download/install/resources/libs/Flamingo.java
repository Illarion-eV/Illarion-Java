...
/**
 * This resource contains the Flamingo Components for Swing.
 *
 * @author Martin Karing
 */
public final class Flamingo
        implements LibraryResource {
    /**
     * The singleton instance of this class.
     */
    private static final Flamingo INSTANCE = new Flamingo();
    ...
    public String getName() {
        return Lang.getMsg(Flamingo.class.getName());
    }
    ...
    public Collection<URL> getRequiredRessources() {
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH + "flamingo" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
