...
/**
 * This resource contains the JSyntaxPane editor for the Swing environment.
 * 
 * @author Martin Karing
 * @since 1.00
 * @version 1.00
 */
public final class JSyntaxPane implements LibraryResource {
    /**
     * The singleton instance of this class.
     */
    private static final JSyntaxPane INSTANCE = new JSyntaxPane();
    ...
    public String getName() {
        return Lang.getMsg(JSyntaxPane.class.getName());
    }
        ...
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH
                    + "jsyntaxpane" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
    ...
    public Collection<String> getVMArguments() {
        if (vmArguments == null) {
            ...
            vmArgs.add("-Dillarion.components.avaiable.jsyntaxpane=true"); //$NON-NLS-1$
