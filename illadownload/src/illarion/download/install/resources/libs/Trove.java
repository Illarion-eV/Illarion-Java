...
/**
 * This resource contains the GNU Trove collection framework.
 * 
 * @author Martin Karing
 * @since 1.00
 * @version 1.00
 */
public final class Trove implements LibraryResource {
    /**
     * The singleton instance of this class.
     */
    private static final Trove INSTANCE = new Trove();
    ...
    public String getName() {
        return Lang.getMsg(Trove.class.getName());
    }
    ...
    public Collection<URL> getRequiredRessources() {
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH + "trove" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
    ...
    public Collection<String> getVMArguments() {
        if (vmArguments == null) {
            ...
            vmArgs.add("-Dillarion.components.avaiable.trove=true"); //$NON-NLS-1$
