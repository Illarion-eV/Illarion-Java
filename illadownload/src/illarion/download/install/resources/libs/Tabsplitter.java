...
/**
 * This resource contains the tabsplitter tab addition for the AWT framework.
 * 
 * @author Martin Karing
 * @since 1.00
 * @version 1.00
 */
public final class Tabsplitter implements LibraryResource {
    /**
     * The singleton instance of this class.
     */
    private static final Tabsplitter INSTANCE = new Tabsplitter();
    ...
    public String getName() {
        return Lang.getMsg(Tabsplitter.class.getName());
    }
    ...
    public Collection<String> getVMArguments() {
        if (vmArguments == null) {
            ...
            vmArgs.add("-Dillarion.components.avaiable.tabsplitter=true"); //$NON-NLS-1$
