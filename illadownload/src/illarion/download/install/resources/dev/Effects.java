...
/**
 * This resource contains the Effects graphics.
 * 
 * @author Martin Karing
 * @since 1.00
 * @version 1.00
 */
public final class Effects implements DevelopmentResource {
    /**
    ...
    public Collection<File> getClassPath() {
        if (classpath == null) {
            ...
            cp.add(new File(DevelopmentResourceDirectory.getInstance()
                .getDirectory(), "rsc_effects.jar")); //$NON-NLS-1$
    ...
    public String getName() {
        return Lang.getMsg(Effects.class.getName());
    }
        ...
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH
                    + "rsc_effects" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
