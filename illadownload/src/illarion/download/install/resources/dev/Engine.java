...
import illarion.download.install.resources.libs.Xpp;
...
/**
 * This resource contains the Illarion Game Engine.
 *
 * @author Martin Karing
 */
public final class Engine implements DevelopmentResource {
    /**
    ...
    public Collection<File> getClassPath() {
        if (classpath == null) {
            ...
            cp.add(new File(DevelopmentDirectory.getInstance().getDirectory(), "illarion_engine.jar")); //$NON-NLS-1$
    ...
    public String getName() {
        return Lang.getMsg(Engine.class.getName());
    }
    ...
    public Collection<URL> getRequiredResources() {
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH + "illarion_engine" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
