...
import illarion.download.install.resources.libs.Slick;
...
/**
 * This resource contains the Illarion Game Engine - Slick2D Backend.
 *
 * @author Martin Karing
 */
public final class EngineSlick implements DevelopmentResource {
    /**
     * The singleton instance of this class.
     */
    private static final EngineSlick INSTANCE = new EngineSlick();
    ...
    public Collection<File> getClassPath() {
        if (classpath == null) {
            ...
            cp.add(new File(DevelopmentDirectory.getInstance().getDirectory(),
                    "illarion_engine_slick.jar")); //$NON-NLS-1$
    ...
    public String getName() {
        return Lang.getMsg(EngineSlick.class.getName());
    }
    ...
    public Collection<URL> getRequiredResources() {
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH + "illarion_engine_slick" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
