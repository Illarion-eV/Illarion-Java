...
/**
 * This resource contains the GUI graphics.
 * 
 * @author Martin Karing
 * @since 1.00
 * @version 1.00
 */
public final class Gui implements DevelopmentResource {
    /**
    ...
    public Collection<File> getClassPath() {
        if (classpath == null) {
            ...
            cp.add(new File(DevelopmentResourceDirectory.getInstance()
                .getDirectory(), "rsc_gui.jar")); //$NON-NLS-1$
    ...
    public String getName() {
        return Lang.getMsg(Gui.class.getName());
    }
    ...
    public Collection<URL> getRequiredRessources() {
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH + "rsc_gui" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
