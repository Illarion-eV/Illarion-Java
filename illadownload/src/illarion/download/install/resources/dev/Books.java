...
/**
 * This resource contains the books.
 * 
 * @author Martin Karing
 * @since 1.00
 * @version 1.00
 */
public final class Books implements DevelopmentResource {
    /**
    ...
    public Collection<File> getClassPath() {
        if (classpath == null) {
            ...
            cp.add(new File(DevelopmentResourceDirectory.getInstance()
                .getDirectory(), "rsc_books.jar")); //$NON-NLS-1$
    ...
    public String getName() {
        return Lang.getMsg(Books.class.getName());
    }
