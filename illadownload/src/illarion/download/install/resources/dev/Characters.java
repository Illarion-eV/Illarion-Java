...
/**
 * This resource contains the Character graphics.
 * 
 * @author Martin Karing
 * @since 1.00
 * @version 1.00
 */
public final class Characters implements DevelopmentResource {
    /**
    ...
    public Collection<File> getClassPath() {
        if (classpath == null) {
            ...
            cp.add(new File(DevelopmentResourceDirectory.getInstance()
                .getDirectory(), "rsc_chars.jar")); //$NON-NLS-1$
    ...
    public String getName() {
        return Lang.getMsg(Characters.class.getName());
    }
    ...
    public Collection<URL> getRequiredRessources() {
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH + "rsc_chars" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
