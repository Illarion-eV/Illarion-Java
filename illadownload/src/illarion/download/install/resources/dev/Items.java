...
/**
 * This resource contains the Item graphics.
 * 
 * @author Martin Karing
 * @since 1.00
 * @version 1.00
 */
public final class Items implements DevelopmentResource {
    /**
    ...
    public Collection<File> getClassPath() {
        if (classpath == null) {
            ...
            cp.add(new File(DevelopmentResourceDirectory.getInstance()
                .getDirectory(), "rsc_items.jar")); //$NON-NLS-1$
    ...
    public String getName() {
        return Lang.getMsg(Items.class.getName());
    }
    ...
    public Collection<URL> getRequiredRessources() {
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH + "rsc_items" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
