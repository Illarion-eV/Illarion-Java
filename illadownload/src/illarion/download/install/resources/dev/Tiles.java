...
/**
 * This resource contains the Tiles graphics.
 * 
 * @author Martin Karing
 * @since 1.00
 * @version 1.00
 */
public final class Tiles implements DevelopmentResource {
    /**
    ...
    public Collection<File> getClassPath() {
        if (classpath == null) {
            ...
            cp.add(new File(DevelopmentResourceDirectory.getInstance()
                .getDirectory(), "rsc_tiles.jar")); //$NON-NLS-1$
    ...
    public String getName() {
        return Lang.getMsg(Tiles.class.getName());
    }
    ...
    public Collection<URL> getRequiredRessources() {
        if (resources == null) {
            ...
            try {
                res.add(new URL(ONLINE_PATH + "rsc_tiles" + RESSOURCE_FILE_EXT)); //$NON-NLS-1$
