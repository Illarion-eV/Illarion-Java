 ...
 * are usable in a LUA and a easyGUI script.
 * 
...
public enum CalculationOperators {
    /**
     * The addition operator with all required data to detect it in a easyGUI
    ...
    /**
     * The set operator with all required data to detect it in a easyGUI
     * script and to write it into a LUA script.
     */
    @SuppressWarnings("nls")
    set("=", "^\\s*=\\s*$"),
    ...
    /**
     * The subtraction operator with all required data to detect it in a easyGUI
     * script and to write it into a LUA script.
     */
    @SuppressWarnings("nls")
    subtract("-", "^\\s*(-[=]*)\\s*$");
    ...
    /**
     * Get the RegExp pattern usable to identify the operator in the easyGUI
     * script.
     * 
