...
public final class LuaWriter {
     ...
     * @throws java.io.IOException thrown in case a writing operation failed
     */
     ...
     * @throws java.io.IOException thrown in case the writing operation fails
     */
     ...
     * @throws java.io.IOException the exception thrown in case the writing functions
     *             fail
     */
     ...
     * 
     * @param target the writer that receives the text written in this function
     * @throws java.io.IOException thrown in case the writing functions fail
     */
    @SuppressWarnings("nls")
    ...
    /**
     * Write the introduction texts for the easyGUI script.
     * 
        ...
        switch (stage) {
            case header:
                ...
                target.write(String.format("-- %1$-47s%2$27s --%n",
                    ...
                    illarion.easygui.Parser.FULLNAME));
     ...
     * @throws java.io.IOException thrown in case there is a problem with writing the
     *             text
     */
