...
/**
 * This is the easyGUI writer. It writes from the data supplied by a parsed NPC
 * a easyGUI script with the proper encoding and the latest state of the syntax.
 * 
...
public final class EasyNpcWriter {
    ...
    /**
     * Write the header of the easyGUI script to the target. This contains the
     * name, the gender, the race, the position and the direction NPC. Every
     * single NPC requires to have this values.
     * 
     * @param source the easyGUI that is the data source for this function
