...
/**
 * This class contains the script data to a easyGUI script. It contains the
...
public final class EasyNpcScript {
    /**
     * The representation of each line in the easyGUI script. It stores the line
     ...
     * parser.
     * 
     * @param sourceFile the file that is read to get the easyGUI data
     * @throws java.io.IOException thrown in case anything goes wrong while reading this
     *             file.
     */
    ...
    /**
     * Get the amount of entries currently load into this easyGUI script.
     * 
     ...
     * @throws java.io.IOException error thrown in case reading failed
     */
     ...
     *            script
     * @throws java.io.IOException thrown in case there is a problem while writing
     */
