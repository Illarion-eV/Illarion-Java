...
import illarion.easygui.writer.EasyNpcWriter.WritingStage;
...
public final class ParsedWalkingRadius implements ParsedData {
    ...
    public boolean effectsLuaWritingStage(
        final illarion.easygui.writer.LuaWriter.WritingStage stage) {
        return false;
    }
    ...
    /**
     * Write the walking radius to the easyGUI script.
     */
    ...
    public void writeEasyNpc(final Writer target, final WritingStage stage)
        ...
        if (stage == WritingStage.header) {
            ...
            target.write(illarion.easygui.writer.EasyNpcWriter.NL);
        }
