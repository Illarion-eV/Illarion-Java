...
public final class ConsequenceDeleteItem implements TalkConsequence {
    ...
    /**
     * The format string for the easyGUI code.
     */
    @SuppressWarnings("nls")
    private static final String EASY_CODE = "deleteItem(%1$s, %2$s)";

    /**
     * The format string for the easyGUI code. This code is used in case there
     * is a data value set.
     */
    @SuppressWarnings("nls")
    ...
    /**
     * Write this delete item consequence into its easyGUI shape
     */
    @Override
