 ...
 * the easyGUI language. Such a number can contain a normal number, a reference
...
public final class AdvancedNumber implements Reusable {
    ...
    /**
     * Get the easyGUI representation of this advanced number value.
     * 
     * @return the easyGUI representation of the advanced number
     */
