...
import illarion.easygui.parser.talk.TalkingLine;

/**
 * This class is used to parse the lines from a easyGUI script that are used for
 * talking NPCs.
 * 
...
public final class NpcTalk implements NpcType {
    /**
     * The pattern to find the quest id of this talking NPC in the easyGUI
     * script.
     */
