...
import illarion.easygui.parsed.talk.consequences.ConsequenceItem;
...
public final class Item extends ConsequenceParser {
    ...
    public TalkConsequence extract() {
        ...
        if (stringMatcher.find()) {
            ...
            final ConsequenceItem itemCons = ConsequenceItem.getInstance();
            itemCons.setData(item, count, quality, data);
            return itemCons;
        }
