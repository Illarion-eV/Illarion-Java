...
import illarion.easygui.EasyNpcScript;
import illarion.easygui.Lang;
import illarion.easygui.ParsedNpc;
import illarion.easygui.docu.DocuEntry;
import illarion.easygui.parsed.ParsedTalk;
...
public final class TalkingLine {
    ...
    public TalkingLine() {
        ...
        condPar.add(new illarion.easygui.parser.talk.conditions.Trigger());
        condPar.add(new illarion.easygui.parser.talk.conditions.State());
        condPar.add(new illarion.easygui.parser.talk.conditions.Skill());
        condPar.add(new illarion.easygui.parser.talk.conditions.Attribute());
        condPar.add(new illarion.easygui.parser.talk.conditions.Money());
        condPar.add(new illarion.easygui.parser.talk.conditions.Race());
        condPar.add(new illarion.easygui.parser.talk.conditions.Queststatus());
        condPar.add(new illarion.easygui.parser.talk.conditions.Item());
        condPar.add(new illarion.easygui.parser.talk.conditions.Language());
        condPar.add(new illarion.easygui.parser.talk.conditions.Chance());
        condPar.add(new illarion.easygui.parser.talk.conditions.Town());
        condPar.add(new illarion.easygui.parser.talk.conditions.Number());
        condPar.add(new illarion.easygui.parser.talk.conditions.Talkstate());
        condPar.add(new illarion.easygui.parser.talk.conditions.Sex());
        condPar.add(new illarion.easygui.parser.talk.conditions.Admin());

        consPar.add(new illarion.easygui.parser.talk.consequences.Inform());
        consPar.add(new illarion.easygui.parser.talk.consequences.Answer());
        consPar.add(new illarion.easygui.parser.talk.consequences.State());
        consPar.add(new illarion.easygui.parser.talk.consequences.Skill());
        consPar.add(new illarion.easygui.parser.talk.consequences.Attribute());
        consPar.add(new illarion.easygui.parser.talk.consequences.Rune());
        consPar.add(new illarion.easygui.parser.talk.consequences.Money());
        consPar
            .add(new illarion.easygui.parser.talk.consequences.DeleteItem());
        consPar.add(new illarion.easygui.parser.talk.consequences.Item());
        consPar
            .add(new illarion.easygui.parser.talk.consequences.Queststatus());
        consPar
            .add(new illarion.easygui.parser.talk.consequences.Rankpoints());
        consPar.add(new illarion.easygui.parser.talk.consequences.Talkstate());
        consPar.add(new illarion.easygui.parser.talk.consequences.Treasure());
        consPar.add(new illarion.easygui.parser.talk.consequences.Introduce());
        consPar.add(new illarion.easygui.parser.talk.consequences.Warp());
