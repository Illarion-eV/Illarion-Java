...
import illarion.easygui.parsed.talk.conditions.ConditionMoney;
import illarion.easygui.parser.talk.AdvNumber;
import illarion.easygui.parser.talk.ConditionParser;

/**
 * This is a money condition. Its able to parse a money value out of the NPC
 * condition line.
 * 
...
public final class Money extends ConditionParser {
     ...
     */
    @SuppressWarnings("nls")
    private static final Pattern MONEY_FIND = Pattern.compile(
    ...
    public TalkCondition extract() {
        ...
        if (stringMatcher.find()) {
            ...
            final ConditionMoney moneyCon = ConditionMoney.getInstance();
            moneyCon.setData(operator, targetValue);
            return moneyCon;
        }
