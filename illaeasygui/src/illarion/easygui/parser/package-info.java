 ...
 */
/**
 * This package contains all main groups of parsers the easyGUI parser uses.
 * They are executed one by one to ensure that the entire script is parsed
 * properly. In case a line appears no parser is able to handle, its considered
 * and error.
 * 
 * @since 1.00
 * @version 1.00
