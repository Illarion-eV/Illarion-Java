 ...
 */
package illarion.easygui.parser;
...
import illarion.easygui.data.BooleanFlagValues;
import illarion.easygui.data.CharacterDirection;
import illarion.easygui.data.CharacterLanguage;
import illarion.easygui.data.CharacterRace;
...
/**
 * This NpcType is able to parse the basic informations out of a easyGUI script.
...
public final class NpcBasics implements NpcType {
    ...
    /**
     * The pattern to find the looking direction of the NPC in the easyGUI
     * script.
     */
    @SuppressWarnings("nls")
    ...
    /**
     * The pattern to find the name of the NPC in this easyGUI script.
     */
    @SuppressWarnings("nls")
    ...
    /**
     * The pattern to find the position of the NPC in the easyGUI script.
     */
    @SuppressWarnings("nls")
    ...
    /**
     * The pattern to find the race of the NPC in the easyGUI script.
     */
    @SuppressWarnings("nls")
    ...
    /**
     * The pattern to find the sex of the NPC in the easyGUI script.
     */
    @SuppressWarnings("nls")
