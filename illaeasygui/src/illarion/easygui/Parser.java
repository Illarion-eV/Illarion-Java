...
import illarion.easygui.gui.Config;
import illarion.easygui.parser.NpcType;

import illarion.common.util.Crypto;
import illarion.common.util.TableLoader;

/**
 * This class parses a easyGUI script that contains the plain script data to a
...
public final class Parser implements DocuEntry {
    ...
    public static final String APPLICATION = "Illarion easyGUI";

    /**
     * The full name of the application. (Name and Version)
     */
    @SuppressWarnings("nls")
    public static final String FULLNAME = "easyGUI Parser v1.02";
    ...
    private Parser() {
        ...
        typeList.add(new illarion.easygui.parser.NpcComment());
        typeList.add(new illarion.easygui.parser.NpcBasics());
        typeList.add(new illarion.easygui.parser.NpcColors());
        typeList.add(new illarion.easygui.parser.NpcHair());
        typeList.add(new illarion.easygui.parser.NpcEquipment());
        typeList.add(new illarion.easygui.parser.NpcTalk());
        typeList.add(new illarion.easygui.parser.NpcEmpty());
        typeList.add(new illarion.easygui.parser.NpcCycleText());
        typeList.add(new illarion.easygui.parser.NpcWalk());
     ...
     *            parse
     * @throws java.io.IOException in case the script can't be read
     */
    @SuppressWarnings("nls")
     ...
     * @throws java.io.IOException in case reading the script fails
     */
    @SuppressWarnings("nls")
     ...
     * 
     * @param source the easyGUI source script that is supposed to be parsed.
