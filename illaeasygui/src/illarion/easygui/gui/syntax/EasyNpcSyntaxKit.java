 ...
 */
package illarion.easygui.gui.syntax;
...
/**
 * This is the Syntax Kit used to handle the syntax highlighting of the easyGUI
...
public final class EasyNpcSyntaxKit extends DefaultSyntaxKit {
    /**
     * The serialization UID of this easyGUI Syntax Kit.
     */
    ...
    public EasyNpcSyntaxKit() {
        ...
        try {
            props.load(EasyNpcSyntaxKit.class.getClassLoader()
                .getResourceAsStream(
                    "illarion/easygui/gui/syntax/easyGUI.properties"));
