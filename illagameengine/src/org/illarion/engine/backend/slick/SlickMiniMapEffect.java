...
class SlickMiniMapEffect implements MiniMapEffect, SlickTextureEffect {
    ...
    public void activateEffect(@Nonnull final Graphics graphics) {
        final float miniMapCenterX = (float) (centerX - radius) / (float) WorldMap.WORLD_MAP_WIDTH;
        final float miniMapCenterY = (float) (centerY - radius) / (float) WorldMap.WORLD_MAP_HEIGHT;
