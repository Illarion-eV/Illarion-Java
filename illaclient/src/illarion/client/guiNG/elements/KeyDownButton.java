 ...
 * @version 1.22
 */
public class KeyDownButton extends Widget {
    /**
    ...
    public void handleMouseEvent(final MouseEvent event) {
        ...
        if (((event.getEvent() == MouseEvent.EVENT_KEY_DOWN) || ((event
            .getEvent() == MouseEvent.EVENT_KEY_UP) && (event.getKey() == java.awt.event.MouseEvent.BUTTON1)))) {
            ...
            if (isInside(event.getPosX(), event.getPosY())) {
                ...
                if (event.getKey() == MouseEvent.EVENT_KEY_DOWN) {
