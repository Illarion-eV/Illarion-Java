...
public class AvatarTemplate extends AbstractMultiFrameEntityTemplate {
     ...
     */
    public AvatarTemplate(final int id, @Nonnull final Sprite sprite, final int frames, final int stillFrame,
                          @Nullable final Color defaultColor, final int shadowOffset, final int direction,
