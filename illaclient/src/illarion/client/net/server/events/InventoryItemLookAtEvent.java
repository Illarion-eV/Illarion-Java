 ...
 */
public final class InventoryItemLookAtEvent extends AbstractItemLookAtEvent {
    /**
     * The slot in the inventory this tooltip is assigned to.
     */
     ...
     */
    public InventoryItemLookAtEvent(final int slot, final String name, final int rareness, final String description,
