...
/**
 * This event is triggered in case the client received a inform message that was issued by a broadcast message.
 *
...
public final class BroadcastInformReceivedEvent extends AbstractInformReceivedEvent implements ServerEvent {
     ...
     */
    public BroadcastInformReceivedEvent(final String informMessage) {
        super(informMessage);
    }
}
