 ...
 */
public final class DialogItemLookAtEvent extends AbstractItemLookAtEvent {
    /**
    ...
    /**
     * The slot in the dialog this tooltip is assigned to.
     */
     ...
     */
    public DialogItemLookAtEvent(final int dialogId, final int slot, final String name, final int rareness,
                                 final String description, final String producer, final Money worth, final int weight,
