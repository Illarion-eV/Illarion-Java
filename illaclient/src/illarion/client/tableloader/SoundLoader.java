 ...
 * @version 1.22
 */
public final class SoundLoader extends ResourceLoader<Sound> implements
    TableLoaderSink {
    /**
    ...
    public void load() {
        ...
        final ResourceFactory<Sound> factory = getTargetFactory();
    ...
    public boolean processRecord(final int line, final TableLoader loader) {
        ...
        try {
            getTargetFactory().storeResource(new Sound(clipID, filename));
