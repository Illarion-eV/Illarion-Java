 ...
 * @version 1.22
 */
public final class SongLoader extends ResourceLoader<Song> implements
    TableLoaderSink {
    /**
    ...
    public void load() {
        ...
        final ResourceFactory<Song> factory = getTargetFactory();
    ...
    public boolean processRecord(final int line, final TableLoader loader) {
        ...
        try {
            getTargetFactory().storeResource(new Song(clipID, filename));
