...
public final class Pack200Helper {
    ...
    private static final String CODE_ATTRIB_LOCAL_VAR_TABLE = "LocalVariableTable";
    ...
    static {
        ...
        PROPS.put(Pack200.Packer.CODE_ATTRIBUTE_PFX + CODE_ATTRIB_LOCAL_VAR_TABLE, Pack200.Packer.STRIP);
