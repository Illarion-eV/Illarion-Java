...
public final class Layers {
    /**
     * The character layer. All character, NPCs and monsters are rendered on this layer.
     */
    public static final int CHARS = 320;

    /**
     * The depth of a layer in case a object is behind another object. This is mainly needed as the location
     * calculation.
     */
    ...
    /**
     * The layer per level. Means how much is added or subtracted from or to other layer levels in case a object is a
    ...
    /**
     * The private constructor, used to ensure that nothing creates a instance of this utility class.
     */
    private Layers() {
        // this constructor only blocks that nothing can create a instance of this class.
    }
}
