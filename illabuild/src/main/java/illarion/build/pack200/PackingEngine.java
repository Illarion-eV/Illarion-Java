...
public final class PackingEngine {
     ...
     */
    @SuppressWarnings("nls")
    public void pack(@Nonnull final File jarFile) {
     ...
     */
    @SuppressWarnings("nls")
    public void repack(@Nonnull final File jarFile) {
        File tempFile;
        try {
     ...
     */
    @SuppressWarnings("nls")
    public void setDestinationDir(@Nullable final File dir) {
        if (dir == null) {
            destination = null;
            return;
        }
     ...
     */
    private void copyPropertiesTo(@Nonnull final Map<String, String> target) {
        target.putAll(props);
    }
