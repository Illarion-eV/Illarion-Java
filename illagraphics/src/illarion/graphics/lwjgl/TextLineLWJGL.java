 ...
 * LWJGL. It has no align but it is possible that it shows a text cursor and
 * marked text.
 * 
 ...
 * @since 2.00
 */
public final class TextLineLWJGL extends AbstractTextLine {
    /**
    ...
    public void setColor(final SpriteColor newColor) {
        if (newColor != null) {
            if (newColor instanceof SpriteColorLWJGL) {
    ...
    public void setFont(final RenderableFont newFont) {
        if (newFont instanceof RenderableFontLWJGL) {
