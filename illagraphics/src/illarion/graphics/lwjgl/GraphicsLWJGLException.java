 ...
 * @since 2.00
 */
public class GraphicsLWJGLException extends GraphicsException {
    /**
     ...
     */
    public GraphicsLWJGLException(final String message) {
        super(message);
    }
     ...
     */
    public GraphicsLWJGLException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public GraphicsLWJGLException(final Throwable cause) {
        super(cause);
    }
}
