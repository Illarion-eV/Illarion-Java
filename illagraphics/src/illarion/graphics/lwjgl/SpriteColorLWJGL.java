 ...
 * @since 2.00
 */
public final class SpriteColorLWJGL implements SpriteColor {
    /**
     ...
     */
    protected SpriteColorLWJGL(final SpriteColorLWJGL org) {
        red = org.red;
        green = org.green;
        blue = org.blue;
        alpha = org.alpha;
     ...
     */
    protected SpriteColorLWJGL(final float newRed, final float newGreen,
        final float newBlue) {
     ...
     * @param newBlue the blue share of the new color
     */
    protected SpriteColorLWJGL(final int newRed, final int newGreen,
        final int newBlue) {
        red = newRed;
        green = newGreen;
        blue = newBlue;
    ...
    /**
     * Reset the stored active color;
     */
    static void resetActiveColor() {
        ACTIVE.set(SpriteColor.COLOR_MIN);
        ACTIVE.setAlpha(SpriteColor.COLOR_MIN);
    }
    ...
    public boolean equals(final Object o) {
        ...
        final SpriteColorLWJGL tempColor = (SpriteColorLWJGL) o;
    ...
    public final void set(final SpriteColor color) {
        ...
        if (color instanceof SpriteColorLWJGL) {
            final SpriteColorLWJGL tempColor = (SpriteColorLWJGL) color;
            red = tempColor.red;
