 ...
 * @since 2.00
 */
public final class SpriteColorJOGL implements Cloneable, SpriteColor {
    /**
     ...
     */
    protected SpriteColorJOGL(final SpriteColorJOGL org) {
        red = org.red;
        green = org.green;
        blue = org.blue;
        alpha = org.alpha;
     ...
     */
    protected SpriteColorJOGL(final float newRed, final float newGreen,
        final float newBlue) {
     ...
     * @param newBlue the blue share of the new color
     */
    protected SpriteColorJOGL(final int newRed, final int newGreen,
        final int newBlue) {
        red = newRed;
        green = newGreen;
        blue = newBlue;
    ...
    public boolean equals(final Object o) {
        ...
        final SpriteColorJOGL tempColor = (SpriteColorJOGL) o;
    ...
    public final void set(final SpriteColor color) {
        ...
        if (color instanceof SpriteColorJOGL) {
            final SpriteColorJOGL tempColor = (SpriteColorJOGL) color;
            red = tempColor.red;
